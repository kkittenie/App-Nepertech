...
<style>
    ...
    .screenshot-modal-header::before {
        content: '';
        position: absolute;
        top: -30px;
        right: -30px;
    ...
    .screenshot-modal-body ul li:hover {
        transform: translateY(-2px);
        background: #f0fdf4;
        border-color: #bbf7d0;
        box-shadow: 0 6px 16px rgba(16, 185, 129, 0.04);
    }
    .screenshot-modal-body ul li strong {
        color: #0f172a;
    }
    ...
    .screenshot-modal-body ul li:hover .li-icon {
        transform: scale(1.1);
    }
    .li-icon-1 { background: rgba(59, 130, 246, 0.1); color: #2563eb; }
    .li-icon-2 { background: rgba(99, 102, 241, 0.1); color: #4f46e5; }
    .li-icon-3 { background: rgba(245, 158, 11, 0.1); color: #d97706; }
    .li-icon-4 { background: rgba(16, 185, 129, 0.1); color: #059669; }
...
<div class="screenshot-modal-overlay" id="screenshotWarningModal">
    <div class="screenshot-modal-box">
        <div class="screenshot-modal-header">
            ...
            <p>Baca sebelum melakukan pembayaran</p>
        </div>
        <div class="screenshot-modal-body">
            <ul>
                <li>
                    <div class="li-icon li-icon-1">
        ...
        <div class="screenshot-modal-footer">
            <button class="btn-mengerti" onclick="dismissScreenshotWarning()">
                <span>Saya Mengerti, Lanjutkan Bayar</span>
